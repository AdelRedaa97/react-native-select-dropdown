...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Dimensions, ActivityIndicator, Modal, I18nManager } from 'react-native';
   ...
   const renderDropdown = () => {
      return (
         ...
         >
            ...
            />
            <View style={[styles.dropdownOverlayView, styles.shadow, dropdownStyle, styles.dropdownOverlayViewForce, styles.dropdownOverlayViewForceRTL]} >
               {
                  (!data || data.length == 0) ?
         ...
         {renderDropdownIcon && renderDropdownIcon()}
         {
            renderCustomizedButtonChild ?
               <View style={[styles.dropdownCustomizedButtonParent]} >
                  {renderCustomizedButtonChild(
                     selectedItem ?
                        buttonTextAfterSelection ? buttonTextAfterSelection(selectedItem, index) : selectedItem :
                        null
                     , index
                  )}
               </View>
